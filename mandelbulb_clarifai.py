...
def main():
    ...
    auth_key = st.sidebar.text_input("Clarifai API Key", type="password")  # Input field for API key in the sidebar
    if st.sidebar.button("Create Module with Metadata"):
    ...
    if st.sidebar.button("Predict with Clarifai"):
